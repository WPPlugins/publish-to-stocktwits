...
jQuery(document).ready(function() { 
  	...
  	jQuery('#connect').attr("href", 'https://api.stocktwits.com/api/2/oauth/authorize?client_id=' + stAccessToken + '&response_type=token&redirect_uri=' +blogurl+'/wp-admin/options-general.php?page=publish_to_stocktwits/publish_stocktwits.php&scope=read,watch_lists,publish_messages');
